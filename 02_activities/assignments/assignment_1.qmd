...
cd "/c/Users/Mahsa Edalatkah/gen_data"
printf "%s\n" rs1861 rs3813199 rs3128342 rs11804831 > ./02_activities/data/SNP_List_A1
plink2 --bfile ./02_activities/data/gwa.qc.A1 --extract ./02_activities/data/SNP_List_A1 --export A --freq --out ./02_activities/data/SNP_List_A1_Additive
head ./02_activities/data/SNP_List_A1_Additive.afreq
```
